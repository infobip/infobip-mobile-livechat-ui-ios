...
experiences on iOS.
  ...
  s.homepage         = 'https://github.com/infobip/infobip-mobile-livechat-ui-ios.git'
  s.license          = { :type => 'Apache-2.0', :file => 'LICENSE' }
  s.author           = { 'Infobip' => 'mobile@infobip.com' }
  s.source           = { :git => 'https://github.com/infobip/infobip-mobile-livechat-ui-ios.git', :tag => s.version.to_s }

  s.ios.deployment_target = '15.0'
  s.swift_version    = '5.9'

  s.source_files     = 'Sources/LiveChatUI/**/*.swift'
  s.module_name      = 'LiveChatUI'
